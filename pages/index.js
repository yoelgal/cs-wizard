    ...
    return (
        <>
            <div style={{marginTop: "20px", justifyContent: "space-evenly"}}>
                ...
                />
                <Header as="h1" style={{textAlign: "left", paddingLeft: "20px", color:"#0070f3"}}>CS Wizard</Header>
            ...
            <div style={{textAlign: "center", marginTop: 20, alignSelf: "center"}}>
                ...
                <span><a className={styles.link} href="https://github.com/yoelgal">
                ...
                <a className={styles.link} style={{paddingLeft:10}} href="https://github.com/yoelgal">
